...
export const MenuPathEnum = Object.freeze({ home: '/home', forum: '/forum', thread: '/thread', profile: '/profile', login: '/login', admin: '/admin' })
export const MenuPageEnum = Object.freeze({ home: Home, forum: ForumList, thread: Thread, profile: Profile, login: Login, admin: Admin })
